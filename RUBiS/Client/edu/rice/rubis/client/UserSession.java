...
//   debugLevel = 0;	
	...
	Producer<String, String> producer = clientStream.createProducer();
	...
	if (debugLevel > 1){
        ...
        else
		{
			...
			try{
				...
				clientStream.runProducer(producer, "0", String.valueOf(timeTaken)+","+String.valueOf(System.currentTimeMillis()/1000));
				if (debugLevel > 0){
